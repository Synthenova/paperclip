export const queryKeys = {
  ...
  agents: {
    ...
    chatThreads: (id: string) => ["agents", "chat-threads", id] as const,
    chatRuns: (id: string, threadId: string) => ["agents", "chat-runs", id, threadId] as const,
  ...
  issues: {
    ...
    localFileMeta: (issueId: string, filePath: string) => ["issues", "local-file-meta", issueId, filePath] as const,
    localFileText: (issueId: string, filePath: string) => ["issues", "local-file-text", issueId, filePath] as const,
