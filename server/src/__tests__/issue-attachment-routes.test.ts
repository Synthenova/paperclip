...
function registerRouteMocks() {
  ...
  vi.doMock("../services/index.js", () => ({
    ...
    issueReferenceFileService: () => ({
      ...
      getManagedById: vi.fn(async () => null),
      createFolderArchive: vi.fn(async () => null),
      createRepoLink: vi.fn(async () => null),
      removeManaged: vi.fn(async () => null),
      materializeForIssue: vi.fn(async () => ({ rootDir: "/tmp/issue-reference-files/test", references: [] })),
    }),
